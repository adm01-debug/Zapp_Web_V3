            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  onClick={() => onPlayTts(buildFullNarrationText())}
                  disabled={isTtsLoading}
                >
                  {isTtsPlaying ? (
                    <>
              ...
              <TooltipContent side="top" className="text-xs">
                Ouvir resumo completo em áudio
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
        ...
        {summary.keyPoints.length > 0 && (
          <div>
            <div className="mb-2 flex items-center justify-between">
              ...
              <TtsButton
                text={'Pontos-chave: ' + summary.keyPoints.join('. ')}
                label="Ouvir pontos-chave"
                isTtsPlaying={isTtsPlaying}
                isTtsLoading={isTtsLoading}
                lastTtsText={lastTtsText}
                onPlayTts={onPlayTts}
        ...
        {summary.nextSteps && summary.nextSteps.length > 0 && (
          <div>
            <div className="mb-2 flex items-center justify-between">
              ...
              <TtsButton
                text={'Próximos passos: ' + summary.nextSteps.join('. ')}
                label="Ouvir próximos passos"
                isTtsPlaying={isTtsPlaying}
                isTtsLoading={isTtsLoading}
                lastTtsText={lastTtsText}
                onPlayTts={onPlayTts}
